...
function AuthenticatedDashboard({ username, onSignOut }: { username: string; onSignOut: () => Promise<void> }) {
  ...
  const isSaving = pauseMutation.isPending || watchlistMutation.isPending || timeframesMutation.isPending || thresholdMutation.isPending || cooldownMutation.isPending || rulesMutation.isPending || publicRefreshMutation.isPending;
