...
const translations = {
  en: {
    ...
    liveMarketTitle: "Live market observations",
    liveMarketSubtitle: "Public Redis-cached data only. Live evidence remains separate from confirmed closed-candle signals.",
    liveUnconfirmedBadge: "Unconfirmed live market observation",
    liveFresh: "LIVE CACHE FRESH",
    liveStale: "LIVE CACHE STALE",
    liveNoData: "No live event available",
    liveLastTrade: "Last trade",
    liveBook: "Best bid / ask",
    liveOpenKline: "In-progress kline",
    liveLatestObservation: "Latest live observation",
    liveNoObservation: "No unconfirmed live observation recorded.",
    liveObservations: "Live observations",
    liveObservationsHelp: "Unconfirmed public-market conditions have their own enabled state, threshold, and cooldown. They never alter confirmed signal controls.",
    liveEnable: "Enable live observations",
    liveDisable: "Disable live observations",
    liveConditions: "Unconfirmed conditions",
    liveThreshold: "Live threshold · {value}%",
    liveCooldown: "Live cooldown",
    liveDisclaimer: "Signals-only: live observations are unconfirmed, no order is placed, and this is not personal financial advice.",
    marketHealth: "Market pipeline health",
  },
  vi: {
    languageEnglish: "English",
    languageVietnamese: "Tiếng Việt",
    ...
    liveMarketTitle: "Quan sát thị trường trực tiếp",
    liveMarketSubtitle: "Chỉ dùng dữ liệu công khai đã lưu trong Redis. Bằng chứng trực tiếp luôn tách biệt với tín hiệu nến đã đóng đã xác nhận.",
    liveUnconfirmedBadge: "Quan sát thị trường trực tiếp chưa xác nhận",
    liveFresh: "BỘ NHỚ ĐỆM TRỰC TIẾP MỚI",
    liveStale: "BỘ NHỚ ĐỆM TRỰC TIẾP CŨ",
    liveNoData: "Chưa có sự kiện trực tiếp",
    liveLastTrade: "Giao dịch gần nhất",
    liveBook: "Giá mua / bán tốt nhất",
    liveOpenKline: "Nến đang hình thành",
    liveLatestObservation: "Quan sát trực tiếp gần nhất",
    liveNoObservation: "Chưa có quan sát trực tiếp chưa xác nhận.",
    liveObservations: "Quan sát trực tiếp",
    liveObservationsHelp: "Điều kiện thị trường công khai chưa xác nhận có trạng thái bật, ngưỡng và thời gian chờ riêng. Chúng không bao giờ thay đổi điều khiển tín hiệu đã xác nhận.",
    liveEnable: "Bật quan sát trực tiếp",
    liveDisable: "Tắt quan sát trực tiếp",
    liveConditions: "Điều kiện chưa xác nhận",
    liveThreshold: "Ngưỡng trực tiếp · {value}%",
    liveCooldown: "Thời gian chờ trực tiếp",
    liveDisclaimer: "Chỉ dành cho tín hiệu: quan sát trực tiếp chưa xác nhận, không có lệnh nào được đặt và đây không phải lời khuyên tài chính cá nhân.",
    marketHealth: "Tình trạng quy trình thị trường",
  },
} as const;
