...
const translations = {
  en: {
    ...
    workspaceResearchDetail: "Chart & confirmed evidence",
    workspaceLive: "Live monitor",
    workspaceLiveDetail: "Public quote & worker state",
    workspaceControls: "Controls",
    workspaceControlsDetail: "Alerts & research rules",
    collectorCache: "Collector cache",
    collectorConnected: "CONNECTED",
    collectorStale: "STALE",
    collectorNotConnected: "NOT CONNECTED",
    collectorUnavailableDetail: "No collector snapshot is available in this deployment.",
    publicQuote: "Public quote fallback",
    publicQuoteDetail: "Request a current public bid/ask without credentials. This does not start the collector.",
    publicQuoteObserved: "Observed {time} · Binance public market-data endpoint",
    refreshQuote: "Refresh quote",
    publicQuoteBadge: "PUBLIC QUOTE",
    publicQuoteOnDemand: "ON DEMAND",
  },
  vi: {
    languageEnglish: "English",
    languageVietnamese: "Tiếng Việt",
    ...
    workspaceResearch: "Nghiên cứu",
    workspaceResearchDetail: "Biểu đồ và bằng chứng đã xác nhận",
    workspaceLive: "Theo dõi trực tiếp",
    workspaceLiveDetail: "Giá công khai và trạng thái bộ chạy",
    workspaceControls: "Điều khiển",
    workspaceControlsDetail: "Cảnh báo và quy tắc nghiên cứu",
    collectorCache: "Bộ nhớ đệm bộ thu thập",
    collectorConnected: "ĐÃ KẾT NỐI",
    collectorStale: "CŨ",
    collectorNotConnected: "CHƯA KẾT NỐI",
    collectorUnavailableDetail: "Chưa có ảnh chụp bộ thu thập trong môi trường triển khai này.",
    publicQuote: "Nguồn giá công khai dự phòng",
    publicQuoteDetail: "Yêu cầu giá mua/bán công khai hiện tại mà không cần thông tin xác thực. Thao tác này không khởi động bộ thu thập.",
    publicQuoteObserved: "Quan sát lúc {time} · điểm cuối dữ liệu thị trường công khai của Binance",
    refreshQuote: "Làm mới giá",
    publicQuoteBadge: "GIÁ CÔNG KHAI",
    publicQuoteOnDemand: "THEO YÊU CẦU",
  },
} as const;
